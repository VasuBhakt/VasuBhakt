...
* **Tech Stack:** `Go` • `FastAPI` • `Gin` • `Redis` • `TimescaleDB` • `Redpanda (Kafka)` • `Docker`
* **Links:** [📂 Source Code](https://github.com/VasuBhakt/Ranabhum)
